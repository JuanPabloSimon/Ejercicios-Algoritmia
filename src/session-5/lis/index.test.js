...
describe.skip("encontrarLIS", () => {
  it("[4, 3, 5, 1, 6] => 3", () =>
    expect(encontrarLIS([4, 3, 5, 1, 6])).toBe(3));
  it("[3, 10, 2, 1, 20] => 3", () =>
    expect(encontrarLIS([3, 10, 2, 1, 20])).toBe(3));
  it("[3, 2] => 1", () => expect(encontrarLIS([3, 2])).toBe(1));
  it("[50, 3, 10, 7, 40, 80] => 4", () =>
    expect(encontrarLIS([50, 3, 10, 7, 40, 80])).toBe(4));
